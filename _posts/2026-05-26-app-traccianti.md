...
<!-- CALLOUT: usa per avvertimenti, regole chiave, fatti importanti --> <!-- Varianti: danger | warning | info | success --> <div class="callout danger"> <strong>Costruiscono le nostre identità digitali</strong> Sono veri e proprie "personas" che utilizzano per veicolare pubblicità, social, spam etc. </div>
...
- **Nome fonte** — Descrizione, [Link](https://url.com/)
- **Nome fonte** — Descrizione, [Link](https://url.com/)
